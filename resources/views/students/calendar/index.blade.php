<x-app-layout>
    ...
    <script>
        ...
        function showAppointmentDetails(event) {
                ...
                <div class="grid grid-cols-1 gap-4">
                    <div class="flex items-center space-x-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-gray-900 dark:text-white">${props.student || 'You'}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
                        ...
                        <div>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Counselor</p>
                            <p class="font-semibold text-gray-900 dark:text-white">${props.counselor}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-gray-900 dark:text-white">${props.category}</p>
                        </div>
                    </div>
            ...
            // FIXED: Set up view details button with correct student route
            document.getElementById('viewDetailsBtn').onclick = function() {
                // Change from admin route to student route
                window.location.href = `/student/appointments/${event.id}`;
            };
