{{-- layouts/sidebar.blade.php (Main sidebar component) --}}
<div>
    <div class="h-full">
        <!-- Backdrop for mobile -->
        ...
        <aside x-show="$store.sidebar.isOpen" 
               ...
               class="top-16 left-0 h-[calc(100vh-4rem)] w-72 max-w-[85vw] sm:max-w-72 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 shadow-xl z-40 transform transition-transform duration-300 ease-in-out"
        ...
        <button @click="$store.sidebar.toggle()"
                class="lg:hidden fixed top-4 left-4 z-50 p-2 rounded-lg bg-white dark:bg-gray-800 shadow-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
