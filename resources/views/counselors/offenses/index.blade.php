<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('counselor.offenses.create') }}" 
            ...
            <div class="bg-white dark:bg-gray-800 shadow-xl rounded-2xl overflow-hidden">
                @if($offenses->isEmpty())
                    <div class="p-8 text-center">
                        <div class="inline-flex h-20 w-20 items-center justify-center rounded-full bg-pink-100 dark:bg-pink-900/30 text-pink-500 mb-4">
                        ...
                        <p class="text-gray-500 dark:text-gray-400">
                            There are no student offenses recorded yet.
                        </p>
                    </div>
                @else
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-200">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex items-center gap-3">
                                                <a href="{{ route('counselor.offenses.show', $offense) }}" 
                                                   class="text-blue-600 dark:text-blue-400 hover:text-blue-900 dark:hover:text-blue-300">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="{{ route('counselor.offenses.edit', $offense) }}"
                                                   class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-300">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                @if(!$offense->resolved)
                                                    <form action="{{ route('counselor.offenses.resolve', $offense) }}" method="POST" class="inline">
                                                        @csrf
                                                        @method('PATCH')
