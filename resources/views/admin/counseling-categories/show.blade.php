    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2">
                ...
                {{-- Admin Edit --}}
                <a href="{{ route('admin.counseling-categories.edit', ['counseling_category' => $category->id]) }}" 
                ...
                @if($category->status !== 'active')
                    <form action="{{ route('admin.counseling-categories.approve', $category->id) }}" method="POST">
                        @csrf
                        @method('PATCH')
                        <button type="submit" 
                ...
                @if($category->status !== 'inactive')
                    <a href="{{ route('admin.counseling-categories.edit', $category->id) }}#admin-feedback" 
