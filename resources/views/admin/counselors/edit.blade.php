    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('admin.counselors.update', $counselor) }}" method="POST" class="space-y-8" novalidate>
                        @csrf
                        @method('PUT')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="first_name" name="first_name" type="text" 
                                        class="mt-1 block w-full" :value="old('first_name', $counselor->user->first_name)" required autofocus />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="middle_name" name="middle_name" type="text" 
                                        class="mt-1 block w-full" :value="old('middle_name', $counselor->user->middle_name)" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="last_name" name="last_name" type="text" 
                                        class="mt-1 block w-full" :value="old('last_name', $counselor->user->last_name)" required />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="email" name="email" type="email" 
                                        class="mt-1 block w-full" :value="old('email', $counselor->user->email)" required 
                                        ...
                                        @foreach(['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'] as $day)
                                            <div class="flex items-center">
                                                <input type="checkbox" name="availability_schedule[]" value="{{ $day }}"
                                                    {{ in_array($day, old('availability_schedule', $counselor->availability_schedule ?? [])) ? 'checked' : '' }}
